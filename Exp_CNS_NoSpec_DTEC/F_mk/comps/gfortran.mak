...
ifdef USE_C_FUNC
  F90FLAGS   += -DUSE_C_FUNC
endif
  FFLAGS   += -J$(mdir) -I$(mdir)
  CFLAGS   += -std=c99 -Wall

  ifdef NDEBUG
    F90FLAGS += -O2 -ftree-vectorize -fno-range-check -cpp
    FFLAGS   += -O2 -ftree-vectorize -fno-range-check
    CFLAGS   += -O2 -ftree-vectorize
  else
    F90FLAGS += -g -fno-range-check -O1 -fbounds-check -fbacktrace -Wuninitialized -Wunused -ffpe-trap=invalid -finit-real=nan  -cpp
