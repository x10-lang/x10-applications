...
contains
  ...
  subroutine advance (U,dt,dx,cfl,eta,alam)
    ...
    double precision :: courno, courno_proc, courno_zero
    type(layout)     :: la
    ...
    do n=1,nfabs(Q)
       ...
       call ctoprim(lo,hi,ng,up,qp,dx,courno_zero)
    end do
    !
  ...
  subroutine ctoprim (lo,hi,ng,u,q,dx,courno)
