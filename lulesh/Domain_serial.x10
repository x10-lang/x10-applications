import Lulesh_serial;
import x10.array.Array_2;

// /*
// public static type Index_t = Long; /* Array_2 subscript and loop index */
// public static type Real_t = double;
// public static type Int_t = int;   /* integer representation */
// */


public class Domain_serial {
	/**************/
	/* Allocation */
	/**************/
	...
	public def AllocateNodalPersistent(var size:Index_t)
	{
		...
		m_xd = new Rail[Real_t](size, 0.) ;
		m_yd = new Rail[Real_t](size, 0.) ;
		m_zd = new Rail[Real_t](size, 0.) ;

		m_xdd = new Rail[Real_t](size, 0.) ;
		m_ydd = new Rail[Real_t](size, 0.) ;
		m_zdd = new Rail[Real_t](size, 0.) ;

		//m_fx = new Rail[Real_t](size) ;
		//m_fy = new Rail[Real_t](size) ;
		//m_fz = new Rail[Real_t](size) ;

		m_nodalMass = new Rail[Real_t](size, 0.) ;
	...
	public def AllocateElemPersistent(var size:Index_t)
	{
		...
		m_nodelist = new Array_2[Index_t](size,8) ;
		...
		m_e = new Rail[Real_t](size, 0.) ;

		m_p = new Rail[Real_t](size, 0.) ;
		m_q = new Rail[Real_t](size) ;
		m_ql = new Rail[Real_t](size) ;
		m_qq = new Rail[Real_t](size) ;

		m_v = new Rail[Real_t](size, 1.0) ;		
	...
	public def nodelist():Array_2[Index_t]    { return m_nodelist ; } 
	...
	static val m_x:Rail[Real_t] = new Rail[Real_t](46*46*46); //上の三行から４６の三乗をもってきた
	static val m_y:Rail[Real_t] = new Rail[Real_t](46*46*46);
	static val m_z:Rail[Real_t] = new Rail[Real_t](46*46*46);
	...
	static val m_fx:Rail[Real_t] = new Rail[Real_t](46*46*46); /* forces */
	static val m_fy:Rail[Real_t] =new Rail[Real_t](46*46*46);
	static val m_fz:Rail[Real_t] = new Rail[Real_t](46*46*46);
	...
	var m_nodelist:Array_2[Index_t]; /* elemToNode connectivity */
