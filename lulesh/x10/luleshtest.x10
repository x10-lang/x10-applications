...
public class luleshtest {
  ...
  public static def InitStressTermsForElems(val numElem:Index_t):Array_2[Real_t] {
  
    // 
    // pull in the stresses appropriate to the hydro integration
    //
    var start:Long = Timer.milliTime();
    var result:Array_2[Real_t] = new Array_2[Real_t](3, numElem);
  ...
  public static def CalcElemShapeFunctionDerivatives(val x:Rail[Real_t], val y:Rail[Real_t], val z:Rail[Real_t]):Pair[Array_2[Real_t], Real_t] {
    val x0 = x(0) ;   
    val x1 = x(1) ;
    val x2 = x(2) ;   
    val x3 = x(3) ;
    ...
    return new Pair[Array_2[Real_t], Real_t](b, volume);
  }
  ...
  public static def CalcElemNodeNormals(var pfxyz:Array_2[Real_t], val x:Rail[Real_t], val y:Rail[Real_t], val z:Rail[Real_t]):Array_2[Real_t] {
    var pfxyzOut:Array_2[Real_t] = new Array_2[Real_t](3, 8);

    /* evaluate face one: nodes 0, 1, 2, 3 */
    var result:Rail[Real_t] = SumElemFaceNormal(pfxyz(0,0), pfxyz(1,0), pfxyz(2,0),
  ...
  public static def SumElemStressesToNodeForces(val B:Array_2[Real_t],
      val stress_xx:Real_t,
      val stress_yy:Real_t,
      val stress_zz:Real_t ):Array_2[Real_t]
  {
    var fxyz:Array_2[Real_t] = new Array_2[Real_t](3,8);
    val pfx0 = B(0,0) ;   
    val pfx1 = B(0,1) ;
    val pfx2 = B(0,2) ;    
    val pfx3 = B(0,3) ;
  ...
  public static def IntegrateStressForElems( val numElem:Index_t,
      var sigxxyyzz:Array_2[Real_t]):Rail[Real_t]
  {
    var B:Array_2[Real_t] = new Array_2[Real_t](3,8); // shape function derivatives
  ...
  public static def CalcElemVolumeDerivative(val xyz:Array_2[Real_t]):Array_2[Real_t]
  {
    var result2:Array_2[Real_t] = new Array_2[Real_t](3, 8);
