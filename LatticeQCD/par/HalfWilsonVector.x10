...
public class HalfWilsonVector {
	...
	@Inline def Store(v : Rail[Double], iw : Long)
	{
		val pos = iw*12;
	...
	@Inline def Load(v : Rail[Double], iw : Long)
	{
		val pos = iw*12;
	...
	@Inline def PackXP(v : Rail[Double], iw : Long) : HalfWilsonVector
	{
		val pos = iw*24;
	...
	@Inline def PackXM(v : Rail[Double], iw : Long) : HalfWilsonVector
	{
		val pos = iw*24;
	...
	@Inline def PackYP(v : Rail[Double], iw : Long) : HalfWilsonVector
	{
		val pos = iw*24;
		//h0 = w0 + w3
	...
	@Inline def PackYM(v : Rail[Double], iw : Long) : HalfWilsonVector
	{
		val pos = iw*24;
		//h0 = w0 - w3
		h0_0r = v(pos+0) - v(pos+18);		h0_0i = v(pos+1) - v(pos+19);
	...
	@Inline def PackZP(v : Rail[Double], iw : Long) : HalfWilsonVector
	{
		val pos = iw*24;
		//h0 = w0 + i*w2
	...
	@Inline def PackZM(v : Rail[Double], iw : Long) : HalfWilsonVector
	{
		val pos = iw*24;
		//h0 = w0 - i*w3
		h0_0r = v(pos+0) + v(pos+13);		h0_0i = v(pos+1) - v(pos+12);
	...
	@Inline def PackTP(v : Rail[Double], iw : Long) : HalfWilsonVector
	{
		val pos = iw*24;
		//h0 = 2.0*w2
	...
	//Dirac representation
	@Inline def PackTM(v : Rail[Double], iw : Long) : HalfWilsonVector
	{
		val pos = iw*24;
		//h0 = 2.0*w0
	...
	@Inline def UnpackXP(v : Rail[Double], iw : Long, cks : Double)
	{
		val pos = iw*24;
	...
	@Inline def UnpackXM(v : Rail[Double], iw : Long, cks : Double)
	{
		val pos = iw*24;
		v(pos+0) += cks*h0_0r;			v(pos+1) += cks*h0_0i;
		v(pos+2) += cks*h0_1r;			v(pos+3) += cks*h0_1i;
	...
	@Inline def UnpackYP(v : Rail[Double], iw : Long, cks : Double)
	{
		val pos = iw*24;
		v(pos+0) += cks*h0_0r;			v(pos+1) += cks*h0_0i;
		v(pos+2) += cks*h0_1r;			v(pos+3) += cks*h0_1i;
	...
	@Inline def UnpackYM(v : Rail[Double], iw : Long, cks : Double)
	{
		val pos = iw*24;
		v(pos+0) += cks*h0_0r;			v(pos+1) += cks*h0_0i;
		v(pos+2) += cks*h0_1r;			v(pos+3) += cks*h0_1i;
	...
	@Inline def UnpackZP(v : Rail[Double], iw : Long, cks : Double)
	{
		val pos = iw*24;
		v(pos+0) += cks*h0_0r;			v(pos+1) += cks*h0_0i;
		v(pos+2) += cks*h0_1r;			v(pos+3) += cks*h0_1i;
	...
	@Inline def UnpackZM(v : Rail[Double], iw : Long, cks : Double)
	{
		val pos = iw*24;
		v(pos+0) += cks*h0_0r;			v(pos+1) += cks*h0_0i;
		v(pos+2) += cks*h0_1r;			v(pos+3) += cks*h0_1i;
	...
	//Dirac representation
	@Inline def UnpackTP(v : Rail[Double], iw : Long, cks : Double)
	{
		val pos = iw*24;
	...
	//Dirac representation
	@Inline def UnpackTM(v : Rail[Double], iw : Long, cks : Double)
	{
		val pos = iw*24;
		v(pos+0) += cks*h0_0r;			v(pos+1) += cks*h0_0i;
		v(pos+2) += cks*h0_1r;			v(pos+3) += cks*h0_1i;
	...
	@Inline def UnpackTMAt(p : Place, v : Rail[Double], iw : Long, cks : Double)
	{
		at(p){
			val pos = iw*24;
			v(pos+0) += cks*h0_0r;			v(pos+1) += cks*h0_0i;
	...
	@Inline def Mult(v : Rail[Double], wIn : HalfWilsonVector, iu : Long) : HalfWilsonVector
	{
		val pos = iu*18;
	...
	@Inline def MultD(v : Rail[Double], wIn : HalfWilsonVector, iu : Long) : HalfWilsonVector
	{
		val pos = iu*18;
		h0_0r = 	v(pos+0) *wIn.h0_0r + v(pos+1) *wIn.h0_0i + 
	...
	@Inline def PackXMultD(v : Rail[Double],w : Rail[Double], iu : Long, iw : Long) : HalfWilsonVector
	{
		val pos = iu*18;
		val wIn = new HalfWilsonVector();
		wIn.PackXM(w,iw);
	...
	@Inline def PackYMultD(v : Rail[Double],w : Rail[Double], iu : Long, iw : Long) : HalfWilsonVector
	{
		val pos = iu*18;
		val wIn = new HalfWilsonVector();
		wIn.PackYM(w,iw);
	...
	@Inline def PackZMultD(v : Rail[Double],w : Rail[Double], iu : Long, iw : Long) : HalfWilsonVector
	{
		val pos = iu*18;
		val wIn = new HalfWilsonVector();
		wIn.PackZM(w,iw);
	...
	@Inline def PackTMultD(v : Rail[Double],w : Rail[Double], iu : Long, iw : Long) : HalfWilsonVector
	{
		val pos = iu*18;
		val wIn = new HalfWilsonVector();
		wIn.PackTM(w,iw);
