...
public class SU3MatrixField extends ParallelComplexField {
	...
	def SetUnit()
	{
		for(i in 0..(nsite*Nfld-1)){
			v()(i*18     ) = 1.0f;			v()(i*18 + 1 ) = 0.0f;
			v()(i*18 + 2 ) = 0.0f;			v()(i*18 + 3 ) = 0.0f;
			v()(i*18 + 4 ) = 0.0f;			v()(i*18 + 5 ) = 0.0f;

			v()(i*18 + 6 ) = 0.0f;			v()(i*18 + 7 ) = 0.0f;
			v()(i*18 + 8 ) = 1.0f;			v()(i*18 + 9 ) = 0.0f;
			v()(i*18 + 10) = 0.0f;			v()(i*18 + 11) = 0.0f;

			v()(i*18 + 12) = 0.0f;			v()(i*18 + 13) = 0.0f;
			v()(i*18 + 14) = 0.0f;			v()(i*18 + 15) = 0.0f;
			v()(i*18 + 16) = 1.0f;			v()(i*18 + 17) = 0.0f;
		}
	}
