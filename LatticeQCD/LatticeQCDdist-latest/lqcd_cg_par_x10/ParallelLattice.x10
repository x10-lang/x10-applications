...
public class ParallelLattice extends Lattice{
	...
	def init()
	{
	  ...
	  //debug
	  // Console.OUT.println("rank: " + rank()());
	  // Console.OUT.println("netPos: " + netPos()(0) + netPos()(1) + netPos()(2) + netPos()(3));
	  ...
	  //debug
 // 	  Console.OUT.println("neighbors: " + neighbors()(0) + neighbors()(1) + neighbors()(2) + neighbors()(3)
