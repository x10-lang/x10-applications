...
public final class TestWilsonSolver {
	...
	public static def main(args : Rail[String])
	{
		...
		val solver = new DistSolverCG(Lx,Ly,Lz,Lt,Npx,Npy,Npz,Npt);
		...
		val u = new DistArray_Block_1[Double](2*3*3*Lx*Ly*Lz*Lt*4);
		val xq = new DistArray_Block_1[Double](2*3*4*Lx*Ly*Lz*Lt);
		val bq = new DistArray_Block_1[Double](2*3*4*Lx*Ly*Lz*Lt);
